        ...
        right: (
            <div className="flex items-center gap-1">
                <button
                    ...
                    className="px-4 py-2 rounded-full bg-white/10 dark:bg-black/20 backdrop-blur-xl border border-white/20 dark:border-white/5 active:scale-95 transition-all text-[11px] font-medium text-neutral-700 dark:text-neutral-200 shadow-sm"
                >
                    History
                </button>
            </div>
