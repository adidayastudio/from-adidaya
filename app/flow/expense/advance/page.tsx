...
export default function ExpenseAdvancePage() {
    return (
        <div className="min-h-screen bg-neutral-50 p-6">
            <Breadcrumb items={[{ label: "Flow" }, { label: "Expense" }, { label: "Advances" }]} />
            <PageWrapper sidebar={<ExpenseSidebar />}>
                <div className="p-4">
                    <h1 className="text-2xl font-bold text-neutral-900">Advances</h1>
                    <p className="text-neutral-500 mt-1">Manage cash advance requests.</p>
