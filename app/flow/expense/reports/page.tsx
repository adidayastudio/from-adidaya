                ...
                <div className="space-y-8 w-full animate-in fade-in duration-500">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-sm text-neutral-500 mt-1">Global expense summaries across projects.</p>
                        </div>
                    ...
                    <div className="rounded-xl border border-dashed border-neutral-300 bg-neutral-50 p-12 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-neutral-500 max-w-sm mt-2">
                            Will include: Expense by Project, Expense by Type, Monthly Summary. Exportable.
                        </p>
                    </div>
                </div>
            </PageWrapper>
