...
import { User, Users, Workflow, Tag, CreditCard, Shield, ChevronRight } from "lucide-react";
...
function SettingCard({ icon, title, description, onClick }: { icon: React.ReactNode; title: string; description: string; onClick?: () => void }) {
    return (
        <button
            onClick={onClick}
            className="flex items-center gap-4 p-5 bg-white rounded-xl border border-neutral-200 hover:border-red-200 hover:shadow-sm transition-all text-left w-full group"
        >
...
export default function ExpenseSettingsPage() {
    ...
    return (
        <div className="min-h-screen bg-neutral-50 p-6">
            <Breadcrumb items={[{ label: "Flow" }, { label: "Expense" }, { label: "Settings" }]} />
                    ...
                    <div className="space-y-4">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-sm text-neutral-500 mt-1">Configure expense system settings.</p>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-4">
                                <SettingCard
                                    ...
                                    title="Approval Flow"
                                    description="Configure multi-level expense approval workflow"
                                />
                                <SettingCard
                                ...
                                <SettingCard
                                    ...
                                    title="Permissions"
                                    description="Role-based access control for expense module"
                                />
                            </div>
                        </div>
                    ) : (
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-4">
                                ...
                                <SettingCard
                                    ...
                                    description="Set your frequently used expense categories"
                                />
                            </div>
