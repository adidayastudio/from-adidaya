...
import { User, Users, Search, Activity, Clock, CheckCircle, FileText, MessageSquare as MessageIcon, Inbox } from "lucide-react";
...
export default function ActivityPage() {
    ...
    return (
        <div className="min-h-screen bg-neutral-50 p-6">
            <Breadcrumb items={[{ label: "Flow" }, { label: "Projects" }, { label: "Activity" }]} />
