...
export default function TrackOverviewPage() {
  ...
  const header = (
    <StandardPageHeader
      ...
      subtitle="Monitor project progress, issues, and inspections."
      action={
  ...
  return (
    <StandardPageWrapper
      breadcrumbItems={[{ label: "Flow" }, { label: "Track" }, { label: "Overview" }]}
        ...
        {viewMode === "team" ? (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white/20 dark:bg-neutral-800/20 backdrop-blur-sm rounded-2xl border border-white/40 dark:border-neutral-700/30 p-6 shadow-sm">
                <h3 className="font-semibold mb-4">Project Status</h3>
                {MOCK_PROJECTS.map((p) => (
                  <div key={p.name} className="flex items-center justify-between py-3 border-b border-neutral-200/50 dark:border-neutral-700/50 last:border-0">
              ...
              <div className="bg-white/20 dark:bg-neutral-800/20 backdrop-blur-sm rounded-2xl border border-white/40 dark:border-neutral-700/30 p-6 shadow-sm">
                ...
                <div className="space-y-3">{MOCK_ALERTS.map((a, i) => (
                  <div key={i} className={clsx("p-4 rounded-xl border", a.type === "warning" ? "bg-orange-50/50 border-orange-200/50" : "bg-blue-50/50 border-blue-200/50")}>
