                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            {col.sortable && !onReorder && sortConfig?.key === col.key && (
                                                sortConfig.direction === "asc"
                                                    ...
                                                    : <ChevronDown className="w-4 h-4 text-blue-600 rotate-180" />
                                            )}
                                            {col.sortable && !onReorder && sortConfig?.key !== col.key && (
                                                <ChevronDown className="w-4 h-4 text-neutral-300 opacity-0 group-hover:opacity-100 transition-opacity" />
                                            )}
                                        </div>
                                    </th>
                                ))}
