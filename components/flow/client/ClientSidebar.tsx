...
====================== */
const NAV_ITEMS = [
  { label: "Overview", path: "/flow/client", icon: LayoutDashboard },
  { label: "Clients", path: "/flow/client/list", icon: Users },
  { label: "Communications", path: "/flow/client/communications", icon: MessageSquare },
  { label: "Contracts", path: "/flow/client/contracts", icon: FileSignature },
  { label: "Billing", path: "/flow/client/billing", icon: Receipt },
  { label: "Reports", path: "/flow/client/reports", icon: BarChart },
  { label: "Settings", path: "/flow/client/settings", icon: Settings },
];
...
export default function ClientSidebar() {
  ...
  const isActive = (path: string) => {
    ...
    if (path === "/flow/client") return pathname === "/flow/client";
