...
export function FinanceViewToggleUI({
    ...
    return (
        <div className="relative inline-flex p-1 items-center h-9 rounded-full bg-white/40 dark:bg-neutral-800/40 backdrop-blur-md border border-white/40 dark:border-neutral-700/30 shadow-sm">
            {/* PERSONAL BUTTON */}
            <button
                onClick={() => setViewMode("personal")}
                className={clsx(
                    "relative flex items-center h-full rounded-full text-[11px] font-medium tracking-tight transition-all duration-300 px-3 py-1.5",
