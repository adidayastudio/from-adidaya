...
export default function StageDocumentPreview({
  ...
  sectionsList.forEach((sec, idx) => {
    ...
    tasksForSection.forEach((t, tIdx) => {
      ...
      const isMainCoverTask = (cleanTaskCode === "01-00" || cleanTaskCode === "00-00");
      ...
      taskPageIndex[`${taskCodeNum}-V2P`] = pageNo;
      taskPageIndex[`${taskCodeNum}-V2L`] = pageNo;
      taskPageIndex[`${cleanTaskCode}-P`] = pageNo;
      taskPageIndex[`${cleanTaskCode}-L`] = pageNo;
      taskPageIndex[`${cleanTaskCode}-V2P`] = pageNo;
      taskPageIndex[`${cleanTaskCode}-V2L`] = pageNo;
  ...
  React.useEffect(() => {
    if (activeSubTask) {
      ...
      if (cleanSub.startsWith("01-00")) {
        setActivePage(1);
        return;
      }
      if (cleanSub.startsWith("01-01")) {
        setActivePage(2);
        return;
      }
      ...
      // Try stripping orientation/V2 suffix (-V2P, -V2L, -P, -L) for template catalog codes
      const baseSub = cleanSub.replace(/-(V2P|V2L|v2p|v2l|P|L)$/i, "");
          ...
          <div className="h-[120px] max-h-[3cm] w-full border-t-2 border-neutral-900 pt-1 grid grid-cols-12 gap-x-2 text-[8px] shrink-0 items-stretch">
            ...
            <div className="col-span-3 border-r border-neutral-200 pr-2 grid grid-rows-4 gap-y-0.5">
              <div className="row-span-2 border-b border-neutral-100 flex flex-col justify-start pt-0.5">
                ...
                <h3 className="text-[10.5px] font-black text-neutral-900 leading-tight mt-1">{titleEn}</h3>
              </div>
  ...
  const renderSinglePageItem = (pageItem: DocumentPageItem, pageNumber: number) => {
    switch (pageItem.type) {
        ...
        return (
          <div className="relative w-full h-full bg-brand-red text-white p-16 flex flex-col justify-between overflow-hidden">
            ...
            <div className="relative z-10 my-auto text-right space-y-3 max-w-lg ml-auto">
              ...
              <p className="text-xl text-white/90 font-medium break-words">{data.projectLocation || "[Project Location]"}</p>
            </div>

            <div className="relative z-10 flex flex-col items-end gap-2 text-right">
              <span className="text-2xl font-black tracking-wider font-mono">{data.projectCode || "#000-ADY"}</span>
      ...
      case "TASK_PAGE":
        if (pageItem.taskCode === "01-00") {
          // Explicit Main Project Cover
          return (
            <div className="relative w-full h-full bg-brand-red text-white p-16 flex flex-col justify-between overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-red-600 via-brand-red to-red-800 opacity-90" />
              <div className="absolute top-0 right-0 w-[450px] h-[450px] bg-red-400/20 rounded-full blur-3xl pointer-events-none" />
            ...
            return (
              <div className="absolute inset-0 w-full h-full bg-white p-4 flex gap-4 overflow-hidden select-none">
                ...
                <div className={clsx("flex-1 h-full relative bg-white flex flex-col justify-between overflow-hidden", !isImagePage && "pt-[0.5cm] px-[0.5cm]")}>
                  ...
                  })() : (pageItem.taskCode === "03-01" || pageItem.taskCode.endsWith("03-01") || pageItem.taskCode.endsWith("03-01-V2L")) ? (
                    /* DESIGN SCOPE & DELIVERABLES (03-01-V2L) */
                    <div className="flex-1 my-auto py-2">
                      <div className="columns-2 gap-8 space-y-4">
                        {[
                          {
                  ...
                  ) : (pageItem.taskCode === "03-02" || pageItem.taskCode.endsWith("03-02") || pageItem.taskCode.endsWith("03-02-V2L")) ? (
                    /* CONSTRUCTION SCOPE & DELIVERABLES (03-02-V2L) */
                    <div className="flex-1 my-auto py-2">
                      <div className="columns-2 gap-8 space-y-4">
                        {[
                          {
                  ...
                  ) : (pageItem.taskCode === "03-03" || pageItem.taskCode.endsWith("03-03") || pageItem.taskCode.endsWith("03-03-V2L")) ? (
                    /* SCOPE EXCLUSIONS (03-03-V2L) */
                    <div className="flex-1 my-auto py-2">
                      <div className="columns-2 gap-8 space-y-4">
                        {[
                          {
                  ...
                  ) : (pageItem.taskCode === "03-04" || pageItem.taskCode.endsWith("03-04") || pageItem.taskCode.endsWith("03-04-V2L")) ? (
                    /* PROJECT ASSUMPTIONS (03-04-V2L) */
                    <div className="flex-1 my-auto py-2">
                      <div className="columns-2 gap-8 space-y-4">
                        {[
                          {
                  ...
                  ) : (pageItem.taskCode.includes("08-01")) ? (
                    /* 08-01-V2L: SIGNOFF & APPROVAL LANDSCAPE KOP V2 */
                    <div className="flex-1 py-1 flex flex-col h-full overflow-hidden justify-center">
                      <div className="grid grid-cols-12 gap-6 items-start">
                        {/* LEFT COLUMN: Declaration Text */}
                        <div className="col-span-6 space-y-3">
                          <div className="space-y-2 text-[11px] leading-relaxed text-neutral-800">
                            <p>
                          ...
                          <div className="space-y-1.5 text-[10px] leading-relaxed text-neutral-500 italic pt-2 border-t border-neutral-100">
                            <p>
                        ...
                        <div className="col-span-6 space-y-5 pl-4 border-l border-neutral-200/80">
                          {/* ADIDAYA STUDIO SIGNATURE BLOCK */}
                          <div className="space-y-4">
                            <span className="inline-block px-3 py-1 rounded-full bg-brand-red text-white text-[10px] font-bold tracking-wide shadow-xs">
                              ADIDAYA STUDIO
                            </span>
                            <div className="grid grid-cols-3 gap-2 pt-6">
                              <div className="border-t border-brand-red/60 pt-1">
                                <span className="text-[11px] font-bold text-neutral-900 block">Good name</span>
                                <span className="text-[9px] font-normal italic text-neutral-400 block">Nama terang</span>
                              </div>
                              <div className="border-t border-brand-red/60 pt-1">
                                <span className="text-[11px] font-bold text-neutral-900 block">Sign</span>
                                <span className="text-[9px] font-normal italic text-neutral-400 block">Tanda tangan</span>
                              </div>
                              <div className="border-t border-brand-red/60 pt-1">
                                <span className="text-[11px] font-bold text-neutral-900 block">Date</span>
                                <span className="text-[9px] font-normal italic text-neutral-400 block">Tanggal</span>
                              </div>
                            </div>
                          </div>
            ...
            <div className="absolute inset-0 w-full h-full bg-white p-4 flex flex-col justify-between overflow-hidden select-none">
              ...
              <div className={clsx("flex-1 w-full relative bg-white flex flex-col justify-between overflow-hidden", !isImagePage && "pt-[0.5cm] px-[0.5cm]")}>
                ...
                {isTOC ? (() => {
                  ...
                  return (
                    ...
                    /* 08-01-V2P: SIGNOFF & APPROVAL PORTRAIT KOP V2 */
                    <div className="flex-1 py-2 flex flex-col justify-around h-full space-y-6">
                      {/* Declaration Paragraphs */}
                      <div className="space-y-4">
                        <div className="space-y-2.5 text-xs leading-relaxed text-neutral-900">
                          <p>
                        ...
                        <div className="space-y-2 text-[11px] leading-relaxed text-neutral-500 italic pt-2.5 border-t border-neutral-100">
                          <p>
                            Pada hari ini, pihak Klien menyatakan bahwa <strong className="font-semibold text-neutral-700">dokumen ini telah ditinjau dan disetujui</strong> sebagai hasil akhir dari tahap yang bersangkutan.
                          </p>
                          <p>
                      ...
                      {/* Studio & Client Signature Blocks */}
              ...
              <div className="h-[120px] max-h-[3cm] w-full border-t-2 border-neutral-900 pt-1 grid grid-cols-12 gap-x-2 text-[8px] shrink-0 items-stretch bg-white relative z-10">
                ...
                <div className="col-span-3 border-r border-neutral-200 pr-2 grid grid-rows-4 gap-y-0.5">
                  <div className="row-span-2 border-b border-neutral-100 flex flex-col justify-start pt-0.5">
                    <span className="text-[7px] font-medium text-neutral-400 block leading-none">Drawing Title</span>
                    <h3 className="text-[10.5px] font-black text-neutral-900 leading-tight mt-1">{displayTaskName}</h3>
                  </div>
                  <div className="border-b border-neutral-100 flex items-center">
                    <div className="grid grid-cols-3 gap-1 font-mono text-[7px] w-full">
                      <div><span className="text-neutral-400 font-medium block text-[6px]">Scale</span><strong className="text-neutral-900">1:200</strong></div>
