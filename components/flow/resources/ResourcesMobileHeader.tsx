...
const RESOURCES_TABS = [
    { id: "overview", label: "Overview", href: "/flow/resources/overview", icon: LayoutGrid },
    ...
    { id: "assets", label: "Assets", href: "/flow/resources/assets", icon: Building2 },
    { id: "services", label: "Services", href: "/flow/resources/services", icon: Handshake },
    { id: "activity-log", label: "Activity", href: "/flow/resources/activity-log", icon: History },
];

export default function ResourcesMobileHeader({
    backUrl = "/dashboard",
    rightToolbar
}: {
    backUrl?: string;
    ...
    const isActive = (href: string) => {
        if (href === "/flow/resources/overview") {
            return pathname === "/flow/resources/overview" || pathname === "/flow/resources";
        }
        ...
        <>
            ...
            <div className="lg:hidden pt-20 pb-2">
                <div className="px-5 pb-1">
                    <h1 className="text-[32px] font-bold text-gray-900 dark:text-white tracking-tight">Resources</h1>
                </div>
            </div>
