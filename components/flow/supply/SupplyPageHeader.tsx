...
export default function SupplyPageHeader({
  view,
  onChangeView,
  onAddProcurement,
}: {
  view: SupplyView;
  onChangeView: (v: SupplyView) => void;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        <PageHeader
          title="Supply"
          description="Manage procurement, vendors, and material supply chains."
          actions={
            <Button variant="primary" size="sm" icon={<Plus className="w-4 h-4" />} onClick={onAddProcurement}>
              Add Procurement
            </Button>
          }
        />
