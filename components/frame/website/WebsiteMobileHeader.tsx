    ...
    return (
        <>
            ...
            <div className={`lg:hidden z-30 transition-all duration-300 ${scrolled
                ? "fixed top-[64px] left-5 right-5 bg-white/70 backdrop-blur-2xl backdrop-saturate-[1.8] border border-black/[0.04] p-[2px] rounded-[24px] shadow-[0_8px_32px_-12px_rgba(0,0,0,0.1)]"
            ...
            {scrolled && <div className="lg:hidden h-[40px]" />}
        </>
    );
}
