...
import { ProjectView, ProjectStatus, PROJECT_CATEGORIES } from "./types";
            ...
            <div className="flex flex-col gap-6 mb-4">
                <div className="flex items-start justify-between border-b border-neutral-200 pb-4">
                    <div>
                        ...
                        <p className="text-sm text-neutral-500 mt-1">Manage architecture projects, timelines, and publication status.</p>
                    </div>
                    <Button
                        variant="primary"
                        size="sm"
