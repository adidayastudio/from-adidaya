    ...
    <div className="md:mt-0 flex gap-4">
      ...
      {sidebar && (
        <aside className="hidden lg:block w-[240px] shrink-0">
          <div className="sticky top-0">
            <div className="bg-white/20 dark:bg-neutral-800/20 backdrop-blur-md rounded-[18px] p-4 border border-white/40 dark:border-neutral-700/30 shadow-sm">
              {sidebar}
            </div>
          </div>
        </aside>
      ...
      <main className="flex-1 min-w-0">
        ...
        <div className={clsx(
          ...
          <div className={clsx(!fullWidth && !isTransparent && "p-6 lg:p-8")}>
            {children}
          </div>
        </div>
      </main>
