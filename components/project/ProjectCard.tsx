...
export default function ProjectCard({ project, onClick }: ProjectCardProps) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-5 right-5 w-10 h-10 rounded-full bg-white/80 dark:bg-black/50 backdrop-blur-xl flex items-center justify-center shadow-sm">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end pointer-events-none">
                <div className="pointer-events-auto">
                    {/* Code Badge */}
                    <div className="mb-2">
                        <span className="px-2.5 py-1 bg-white dark:bg-neutral-800 text-[11px] font-bold tracking-wider text-neutral-800 dark:text-neutral-200 rounded-lg shadow-sm border border-neutral-100 dark:border-neutral-700">
                            {project.projectCode}
                        </span>
                    </div>
