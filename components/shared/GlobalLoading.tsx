...
export function GlobalLoading({ forceShow = false }: GlobalLoadingProps) {
        ...
        <AnimatePresence>
            {visible && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[99999] flex items-center justify-center bg-white/[0.1] backdrop-blur-[40px] pointer-events-auto border-white/20 border-t"
                >
                    <div className="relative w-24 h-24 flex items-center justify-center">
                        {/* Background Base Logo (Grey) */}
                        <svg
                            viewBox="0 0 964.35 1080"
                            className="absolute inset-0 w-full h-full text-neutral-400 fill-current opacity-20"
                        >
