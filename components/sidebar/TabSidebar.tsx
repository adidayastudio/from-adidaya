...
export default function TabSidebar({ items, activeTabId, onTabChange }: TabSidebarProps) {
    return (
                ...
                {items.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            className={clsx(
                                "group relative w-full text-left rounded-lg text-[12px] transition-all flex items-center justify-between px-3 py-1.5",
                                active
                                    ...
                                    : "text-neutral-500 hover:bg-neutral-800/10 dark:hover:bg-neutral-200/5 hover:text-neutral-800 dark:hover:text-neutral-200 font-medium"
                            )}
                        >
                            ...
                            {item.count !== undefined && (
                                <span
                                    className={clsx(
                                        "relative z-10 min-w-5 h-5 flex items-center justify-center rounded-full text-[10px] font-bold px-1.5 shrink-0 transition-all",
                                        active
