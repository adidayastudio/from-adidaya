...
async function run() {
    ...
    try {
        ...
        const sqlPath = path.resolve(__dirname, '../supabase/migrations/20260518_add_task_attachment_urls.sql');
        const sql = fs.readFileSync(sqlPath, 'utf8');

        console.log("Running Migration: 20260518_add_task_attachment_urls.sql");
