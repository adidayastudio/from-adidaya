...
async function seedMaterials() {
    console.log("🚀 Seeding Material Data for Kota Semarang...");
    ...
    console.log(`Found ${items.length} materials to insert.`);
    ...
    const payload = items.map((item: any) => ({
        ...
        description: item.sub_category ? `Sub-Cat: ${item.sub_category}` : 'Auto-imported'
    }));
